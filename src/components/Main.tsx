import { Box, Card, CardContent, Checkbox, CircularProgress, Slider, Switch, TextField, TextFieldProps, Typography, useTheme } from "@mui/material";
      ...
      <CardContent>
        <Stack direction="column" spacing={5}>
          ...
          <Stack direction="row" spacing={5}>
            ...
            <StyledTextField value={"styled text field"} multiline size="small" rows={4} />
          </Stack>
